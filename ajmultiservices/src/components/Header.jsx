    ...
    return (
        <header className="sticky top-0 z-51 bg-black/80 backdrop-blur-md px-6 py-8 flex justify-between items-center border-b border-gray-800">
            ...
            <nav className="space-x-6 font-bold tracking-wider">
                <Link to="/">
                    <Button variant="ghost" className="hover:text-gray-700 cursor-pointer">Home</Button>
                </Link>
                <Link to="#">
                    <Button variant="ghost" className="hover:text-gray-700 cursor-pointer">Gallery</Button>
                </Link>
                <Link to="#">
                    <Button variant="ghost" className="hover:text-gray-700 cursor-pointer">Contact</Button>
                </Link>
            </nav>
            <Link to="/quote">
